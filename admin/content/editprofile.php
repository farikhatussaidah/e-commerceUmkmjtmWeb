                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="aksi/edit_profile.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control Nama" placeholder="Atas Nama UKM" name="nama_profile" value="<?= $data['nama_toko']?>">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="No Telepon" name="email_profile" value="<?= $data['email_toko']?>">
                                        </div>
                                        <div class="form-group">
