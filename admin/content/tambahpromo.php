                                ...
                                <div class="basic-form">
                                    <form action="aksi/tambah_promo.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <input type="text" class="form-control Nama" placeholder="Nama Promo" name="nama_promo">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control Harga" placeholder="Syarat Promo" name="syarat_promo">
                                        </div>
                                        <div class="form-group">
