                                    ...
                                    <div class="row">
                                        <div class="col-md-10" style="padding-right:1px">
                                            <form action="aksi/edit_promo.php  " method="post">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control Nama" placeholder="Nama" name="nama_promo" value="<?php echo $data['promo'] ?>">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control Harga" placeholder="Harga" name="syarat_promo" value="<?php echo $data['syarat_promo'] ?>">
                                                </div>
                                                <center>
