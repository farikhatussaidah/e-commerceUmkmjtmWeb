                                ...
                                <div class="basic-form">
                                    <form action="aksi/tambah_profile.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <input type="text" class="form-control Nama" placeholder="Nama UKM" name="nama_ukm">
                                        </div>
                                        <div class="form-group">
                                            <?php
                                        ...
                                        <div class="form-group">
                                            <input type="date" class="form-control" placeholder="Tanggal Berdiri" name="tgl_berdiri">
                                        </div>
                                        <div class="form-group">
                                            <textarea class="form-control" placeholder="Alamat" name="alamat"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="No Telepon" name="no_telpUKM">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="file" name="logo_ukm" id="" class="form-control">
                                        </div>
                                        <center>
